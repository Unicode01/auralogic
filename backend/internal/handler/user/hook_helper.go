...
func buildOptionalUserHookExecutionContext(
	c *gin.Context,
	userID *uint,
...
func buildUserHookExecutionContext(
	c *gin.Context,
	userID uint,
	extra map[string]string,
) *service.ExecutionContext {
	uid := userID
	return buildOptionalUserHookExecutionContext(c, &uid, extra)
}

func cloneUserHookExecutionContext(execCtx *service.ExecutionContext) *service.ExecutionContext {
	if execCtx == nil {
		return nil
	}
...
func mergeUserHookStructPatch(target interface{}, patch map[string]interface{}) error {
...
func userHookStructToPayload(value interface{}) (map[string]interface{}, error) {
	if value == nil {
