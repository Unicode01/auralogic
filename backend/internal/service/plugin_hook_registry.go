...
var hookDefinitions = map[string]hookDefinition{
	...
	"marketing.preview.before":      newRestrictedHookDefinition("marketing.preview.before", hookPhaseBefore, "title", "content", "user_id"),
	"marketing.send.after":          newReadOnlyHookDefinition("marketing.send.after", hookPhaseAfter),
	"marketing.send.before":         newRestrictedHookDefinition("marketing.send.before", hookPhaseBefore, "title", "content", "send_email", "send_sms", "target_all", "user_ids"),
