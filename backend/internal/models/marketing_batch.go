...
type MarketingBatch struct {
	...
	AudienceMode       string                 `gorm:"type:varchar(20);not null;default:'all'" json:"audience_mode"`
	AudienceQuery      map[string]interface{} `gorm:"type:text;serializer:json" json:"audience_query,omitempty"`
